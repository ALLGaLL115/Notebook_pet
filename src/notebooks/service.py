...
class NotebookService():
    ...
    async def get_notebook_by_id(notebook_id:int, db:AsyncSession): 
    ...
    async def create_notebook(new_notebook: NotebookBase, db:AsyncSession):
    ...
    async def change_title(notebook_id:int, new_title:str, db: AsyncSession):
    ...
    async def delete_notebook_by_id(notebook_id:int, db:AsyncSession):
        notebook_db = get
